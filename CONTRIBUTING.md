...
# Contribute to Ory Closed Reference Notifier<!-- omit in toc -->
...
Closed Reference Notifier, please disclose it by contacting us at
security@ory.sh.
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/closed-reference-notifier/blob/master/.github/workflows/conventional_commits.yml)
